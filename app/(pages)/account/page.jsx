...
// This component must be separated to handle useSearchParams
// The error is fixed by wrapping this component in a Suspense boundary
function ClientTabHandler({ setActiveTab }) {
...
export default function AccountPage() {
  ...
  return (
    <>
      {/* Wrap the ClientTabHandler in a Suspense boundary to fix the error */}
      <Suspense fallback={null}>
        <ClientTabHandler setActiveTab={setActiveTab} />
      </Suspense>
            ...
            <div className="w-full lg:w-64 shrink-0">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 text-gray-900 dark:text-white">
                <nav className="space-y-1">
                  ...
                  <button
                    onClick={() => updateActiveTab('bookings')}
                  ...
                  <button
                    onClick={() => updateActiveTab('wishlist')}
                  ...
                  <button
                    onClick={() => updateActiveTab('billing')}
                        ...
                        <div className="flex-1 p-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-gray-600">{booking.tour.startDates && booking.tour.startDates[2] ? booking.tour.startDates[2].split('T')[0] : 'N/A'}</span>
                            </div>
                            <div className="flex items-center">
